...
const de: TranslationSchema = {
  ...
  "settingsPage": {
    ...
    "elaycoinRules": {
      ...
      "intro": "Die Elaycoin-Regeln werden zentral von Elaya verwaltet und gelten für alle Studios einheitlich. Änderungen sind nur im Elaya Admin möglich.",
      "geldwert": "Geldwert: {{coins}} Coins = CHF {{chf}}",
      "tageslimit": "Tageslimit: {{n}} Coins",
      "grenze": "Grenze pro Aktion: {{min}}–{{max}} Coins",
      "verfall": "Coins verfallen nach {{months}} Monaten Inaktivität. Zurücksetzen durch: {{triggers}}.",
      "empty": "Kein Aktionskatalog geladen.",
      "active": "aktiv",
      "malusHint": "Abzug (nie unter 0)",
      "once": "Einmalig",
    ...
    "automations": {
      ...
      "intro": "Automatisierungen senden automatische Chat-Nachrichten an Kunden. Die Regeln werden zentral von Elaya verwaltet. Du kannst freigegebene Regeln ein-/ausschalten und deren Tage-Wert anpassen — neue Regeln anlegen oder löschen ist der Plattform-Verwaltung vorbehalten.",
      "empty": "Noch keine Automatisierungs-Regeln.",
      "active": "aktiv",
      "days": "Tage",
      "locked": "Wird zentral von Elaya verwaltet",
      "on": "AN",
      "off": "AUS"
    },
    "hours": {
  ...
  "adminPages": {
    ...
    "crm": {
      ...
      "onboardingDesc": "Ein Studio durchläuft Lead → Vertrag versendet → Vertrag unterschrieben → Onboarding → aktiv. Nur Studios mit Status AKTIV sind in der Kunden-App buchbar. Website-Webhook / Stripe / E-Signatur können später angebunden werden.",
      "captureLead": "Lead manuell erfassen",
      "captureLeadHint": "Simuliert einen Lead, der später automatisch von der Website oder vom Aussendienst kommt.",
      "leadsEmpty": "Noch keine Studio-Leads erfasst.",
      "leadNoContact": "Keine Kontaktdaten",
      "leadUntitled": "(ohne Firmenname)",
      "leadStatus": {
        "lead": "Lead",
        "contract": "Vertrag versendet",
      ...
      "akquise": {
        "website_demo": "Website — Demo angefragt",
        "website_direkt": "Website — Direktabschluss",
        "aussendienst": "Aussendienst",
        "other": "Sonstiges"
      },
      "payment": {
        "STRIPE_KARTE": "Stripe (Karte)",
        "RECHNUNG": "Rechnung"
      },
      "colFirma": "Firma",
      "colContact": "Ansprechperson",
      "colAkquise": "Akquise-Weg",
      "colPaket": "Paket",
      "colStatus": "Status",
      "colVisible": "Sichtbar für Kunden",
      "colTrial": "Testphase",
      "visibleYes": "Ja",
      "visibleNo": "Nein",
      "details": "Details",
      ...
      "trialEnded": "abgelaufen",
      "trialExpiredNoPay": "Testphase abgelaufen (kein Zahlungsweg)",
      "trialDaysLeft": "{{count}} Tage",
      "trialDaysUntil": "{{count}} Tage verbleibend (bis {{date}})",
      "sectionContract": "Vertrag",
      "sectionAbo": "Abo",
      "contractStatus": "Vertragsstatus",
      "contractSent": "Versendet am",
      "contractSigned": "Unterschrieben am",
      "paymentMethod": "Zahlungsweg",
      "trialActive": "Gratismonat aktiv",
      "actionSendContract": "Vertrag als versendet markieren",
      "actionSignContract": "Vertrag als unterschrieben markieren",
      "actionSetPayment": "Zahlungsweg manuell hinterlegen",
      "actionStartTrial": "Gratismonat starten (30 Tage)",
      "actionActivate": "Studio aktivieren",
      "actionDeactivateTrial": "Testphase abgelaufen — jetzt deaktivieren",
      "activeHint": "Studio ist aktiv und gilt in der Kunden-App als buchbar.",
      "deactivatedHint": "Dieses Studio ist deaktiviert und für Kunden nicht buchbar.",
      "leadActionOk": "Status aktualisiert",
      "leadActionError": "Status konnte nicht aktualisiert werden",
      "leadFirma": "Firmenname",
      "leadContact": "Ansprechperson",
      "leadEmail": "E-Mail",
      "leadPhone": "Telefon",
      "leadCity": "Ort",
      "leadAddress": "Adresse",
      "leadAkquise": "Akquise-Weg",
      "leadPaket": "Gewünschtes Paket",
      "leadDemoBooked": "Demo-Termin gebucht",
      "leadDemoDate": "Demo-Datum",
      "leadNote": "Notiz",
      "leadFirmaRequired": "Firmenname ist erforderlich",
    ...
    "engineSimulator": {
      ...
      "laserDevice": "Laser",
      "wavelengths": "Wellenlängen",
      "laserProfile": "Laserprofil (Engine)",
      "yourStudioLaser": "Dein Studio-Laser",
      "strengths": "Stärken",
      "weaknesses": "Schwächen / Limitationen",
      "noLasers": "Keine Laser im Katalog",
      "size": "Grösse",
      "sizeLxb": "Länge × Breite",
      "sizeDirect": "Direkt cm²",
      "fitzpatrick": "Fitzpatrick",
      "fitzType": "Typ {{type}}",
      ...
      "priorTreatment": "Vorbehandlung (Laser)",
      "priorCount": "Bisherige Sitzungen",
      "pmu": "PMU (Festpreis)",
      "colorsTitle": "Farben",
      "age": "Alter",
      "height": "Grösse (cm)",
      ...
      "hydration": "Hydration",
      "nutrition": "Ernährung",
      "aftercare": "Nachsorge-Commitment",
      "healing": "Heilungsverlauf",
      "lightening": "Hellungsrate",
      "lighteningAuto": "Auto / unbekannt",
      "resultTitle": "Live-Ergebnis",
      "pricePerSession": "Preis / Sitzung",
      "predictedSessions": "Prognostizierte Sitzungen",
      "estimatedTotal": "Geschätzte Gesamtkosten",
      "lifestyleIndex": "Lifestyle-Index",
      "colorDifficulty": "Farb-Schwierigkeit",
      "showDetails": "Berechnungsdetails anzeigen",
      "sessionFactors": "Sitzungsfaktoren",
      "lifestyleMult": "Lifestyle-Multiplikator",
      "ampel": { "green": "Grün", "orange": "Orange", "red": "Rot" },
      "difficulty": { "low": "Niedrig", "medium": "Mittel", "high": "Hoch" },
      "colors": {
        "black": "Schwarz",
        "grey": "Grau",
        "red": "Rot",
    ...
    "documentsPage": {
      "subtitle": "Zentrale Verwaltung von Merkblättern, Anamnese-Fragen, Einwilligungen und FAQs. Dokumente können global oder studio-spezifisch sein und in der Kunden-App oder im Studio-Dashboard erscheinen.",
      ...
      "colVisible": "Sichtbar in",
      "colStatus": "Status",
      "colChanged": "Zuletzt geändert",
      "statusActive": "Aktiv",
      ...
      "deleteConfirm": "Dieses Dokument löschen? Das kann nicht rückgängig gemacht werden.",
      "cancel": "Abbrechen",
      "save": "Speichern",
      "created": "Dokument erstellt",
      "updated": "Dokument aktualisiert",
      "toggled": "Status aktualisiert",
      "deleted": "Dokument gelöscht",
      "titelRequired": "Titel (DE) darf nicht leer sein",
      "studioRequired": "Bitte mindestens ein Studio zuweisen (Studio-spezifisch)",
      "fieldCategory": "Kategorie",
      "fieldTitleDe": "Titel (DE)",
      "fieldTitleEn": "Titel (EN)",
      "fieldContentDe": "Inhalt (DE)",
      "fieldContentEn": "Inhalt (EN)",
      "fieldScope": "Geltungsbereich",
      "fieldStudios": "Zugewiesene Studios",
      "fieldVisible": "Sichtbar in",
      "fieldActive": "Aktiv",
      "noStudios": "Keine Studios verfügbar",
      "filterActive": "Filter aktiv",
      "categories": {
        "merkblatt": "Merkblatt",
        "anamnese_frage": "Anamnese-Frage",
      ...
      "scopes": {
        "global": "Global",
        "studio_spezifisch": "Studio-spezifisch"
      },
      "visibility": {
        "customer_app": "Kunden-App",
    ...
    "finance": {
      ...
      "subtitleAbo": "Reines Abo-Modell: Studio-Abo-Gebühr + Elaya-Anteil am Shop. Keine Transaktionsgebühr. Beträge CHF exkl. MwSt.",
      "aboRecurring": "Wiederkehrender Monatsumsatz",
      "shopElayaMonth": "Shop-Erlös Elaya (akt. Monat)",
      "totalElayaMonth": "Gesamterlös (akt. Monat)",
      "openInvoices": "Offene Rechnungen",
      "aboModelTitle": "Reines Abo-Modell",
      "aboModelRule1": "Erlös = Abo-Gebühr pro Studio + Elaya-Anteil am Shop-Umsatz. KEINE Transaktionsgebühr.",
      "aboModelRule2": "Die Akquisequelle dient nur der Auswertung und hat keinen Einfluss auf die Gebühren.",
      "aboModelRule3": "Alle Beträge in CHF, exkl. MwSt.",
      "totalSales": "Shop-GMV",
      ...
      "empty": "Noch keine Studios",
      "loadError": "Finanzen konnten nicht geladen werden",
      "detailError": "Studio-Finanzen konnten nicht geladen werden",
      "termsSaved": "Konditionen gespeichert",
      "termsSaveError": "Konditionen konnten nicht gespeichert werden",
      "studiosTitle": "Umsatz nach Studio",
      "studiosTitleAbo": "Studios",
      "studiosHint": "Klicke ein Studio, um die verkauften Produkte zu sehen.",
      "studiosHintAbo": "Studio anklicken für Paket, Dual-P&L und Produkte.",
      "backToStudios": "Zurück zu Studios",
      "studioDetailTitle": "Studio-Finanzen",
      "studioDetailSubtitle": "{{code}} · Provision {{pct}}% auf Produktverkäufe",
      "studioDetailSubtitlePeriod": "Periode {{period}} · Studio-Shop-Anteil {{pct}}%",
      "productsSoldTitle": "Verkaufte Produkte (akt. Monat)",
      ...
      "openStudioDetail": "Finanzen öffnen für",
      "blockPackage": "A · Paket & Konditionen",
      "blockPackageHint": "Effektive Abo-Gebühr und Shop-Provision (Override > Paket). Sonderkonditionen brauchen eine Begründung (min. 10 Zeichen).",
      "blockAkquise": "C · Kunden (Auswertung)",
      "akquiseHint": "Akquisequelle ist nur Auswertung — kein Einfluss auf Gebühren.",
      "akquiseStudio": "Studio-eigen",
      "akquisePlatform": "Plattform-vermittelt",
      "akquiseTransfer": "Studiowechsel",
      "plStudio": "D · Studio-P&L (akt. Monat)",
      "plElaya": "D · Elaya-P&L (akt. Monat)",
      "sessionRevenue": "Sitzungs-Umsatz",
      "shopProvision": "Shop-Provision",
      "totalStudio": "Total Studio",
      "aboFee": "Abo-Gebühr",
      "shopElayaShare": "Shop-Anteil Elaya",
      "totalElaya": "Total Elaya",
      "plNote": "Studio-Total und Elaya-Total nicht addieren — getrennte Sichten derselben Periode.",
      "packageLabel": "Paket",
      "preisOverride": "Abo-Override (CHF)",
      "shopOverride": "Shop-Provision Override %",
      "packageDefault": "Paket-Standard",
      "overrideReason": "Begründung Sonderkondition",
      "saveTerms": "Konditionen speichern",
      "clearOverrides": "Overrides löschen",
    ...
    "features": {
      ...
      "planDefaults": "Plan-Standards — Starter: {{basic}} · Pro: {{pro}} · Network: {{ent}} Features",
      "forceOn": "Erzwungen AN",
      "forceOff": "Erzwungen AUS",
      "planDefault": "Paket-Standard",
      "kiWeightsTitle": "KI-Gewichtungen",
      "kiWeightsHint": "Legt fest, wie viele Einheiten des monatlichen KI-Kontingents eine einzelne Nutzung dieser Funktion verbraucht. Höhere Werte für kostenintensive Funktionen (z.B. Bildanalyse).",
      "kiNachsorge": "Nachsorge-Analyse (Einheiten/Nutzung)",
      "kiVerblassung": "Verblassungsanalyse (Einheiten/Nutzung)",
      "kiKundenchat": "Kundenchat (Einheiten/Nutzung)",
      "kiStudioChat": "Studio-KI-Chat (Einheiten/Nutzung)",
      "kiWeightsSave": "KI-Gewichtungen speichern",
      "kiWeightsSaved": "KI-Gewichtungen gespeichert",
      "kiWeightsError": "KI-Gewichtungen konnten nicht gespeichert werden",
      "kiWeightsInvalid": "Bitte für alle Gewichtungen eine gültige Zahl (≥ 0) angeben",
      "packagesTitle": "Elaya Pakete",
      "newPackage": "+ Neues Paket",
      "editPackage": "Bearbeiten",
      "editPackageTitle": "Paket bearbeiten",
      "newPackageTitle": "Neues Paket",
      "packageName": "Name",
      "aboPrice": "Abo-Preis CHF / Monat",
      "description": "Beschreibung",
      "limitsTitle": "Limits",
      "limitsHint": "Leeres Feld = unbegrenzt.",
      "locationsIncl": "Standorte inkl.",
      "surchargeLocation": "Aufpreis/Standort",
      "employees": "Mitarbeiter",
      "shopProvision": "Shop-Provision Studio",
      "shopProvisionHint": "Anteil, den das Studio vom Shop-Umsatz erhält. Individuelle Abweichungen nur über Sonderkonditionen in Finanzen (mit Begründung).",
      "kiQuota": "KI-Kontingent",
      "kiQuotaHint": "Soft-Cap — blockiert nie. Mehrnutzung kann separat abgerechnet werden. Leer = unbegrenzt.",
      "dataRetention": "Datenaufbewahrung",
      "months": "Monate",
      "unlimited": "unbegrenzt",
      "perMonth": "/Monat",
      "featuresActive": "Features aktiv",
      "studiosWithPackage": "Studio(s) mit diesem Paket",
      "featuresTitle": "Features",
      "packageUpdated": "Paket gespeichert",
      "packageCreated": "Paket angelegt",
      "packageError": "Paket konnte nicht gespeichert werden",
      "packageInvalid": "Bitte Name, gültigen Preis und gültige Limits angeben (Shop-Provision ≥ 0)",
      "seatsTitle": "Mitarbeiter-Login-Sitze (pro Plan)",
      "seatsHint": "Wird aus den Paket-Mitarbeiter-Limits synchronisiert. Leer = unbegrenzt.",
      "allOn": "Alle AN",
      "allOff": "Alle AUS",
      "resetPackage": "Paket-Standard",
      "allOnSaved": "Alle Features AN",
      "allOffSaved": "Alle Features AUS",
    ...
    "elaycoins": {
      ...
      "subtitleRules": "Plattformweite Elaycoin-Regeln · Guthaben · Admin-Korrekturen",
      "loadError": "Elaycoins konnten nicht geladen werden",
      ...
      "tabRules": "Regeln",
      "rulesLoadError": "Elaycoin-Regeln konnten nicht geladen werden",
      "rulesSaveError": "Regeln konnten nicht gespeichert werden",
      "rulesSaved": "Elaycoin-Regeln gespeichert",
      "rulesIntro": "Diese Regeln gelten plattformweit für alle Studios. Coins bleiben beim Kunden auch bei Studio-Wechsel — der Wert muss überall gleich sein. Nur Super-Admin kann hier ändern; Studios sehen die Werte nur lesend.",
      "globalTitle": "Globale Einstellungen",
      "geldwert": "Coin-Geldwert",
      "coinsEquals": "Coins = CHF",
      "geldwertHint": "Einlöseeinheit — gilt identisch für alle Studios der Plattform.",
      "tageslimit": "Tageslimit pro Kunde",
      "coinsPerDay": "Coins / Tag",
      "grenzeAktion": "Grenze pro Aktion",
      "min": "Min",
      "max": "Max",
      "coins": "Coins",
      ...
      "catalogTitle": "Kategorien & Aktionen",
      "catalogHint": "Coin-Beträge pro Aktion. Kategorien/Aktionen anlegen, aktiv schalten; Speichern gilt plattformweit.",
      "catalogEmpty": "Keine Aktionen im Katalog.",
      "addCategory": "+ Neue Kategorie",
      "addAction": "+ Aktion",
      "deleteCategory": "Kategorie löschen",
      "deleteAction": "Aktion löschen",
      "promptNewCategory": "Name der neuen Kategorie",
      "confirmDeleteCategory": "Kategorie „{{kat}}“ inkl. aller Aktionen wirklich löschen?",
      "confirmDeleteAction": "Aktion „{{label}}“ wirklich löschen?",
      ...
      "repeatable": "Wiederholbar",
      "limitDays": "Tage",
      "limitDaysHint": "Cooldown in Tagen (limitTage)",
      "on": "AN",
      "off": "AUS",
      "active": "Aktiv",
      "saveRules": "Regeln speichern",
      "superAdminOnly": "Nur Super-Admin kann Regeln bearbeiten."
    },
    "automations": {
      "title": "Automatisierungen",
      "subtitle": "Automatische Kunden-Nachrichten · Plattform-Regeln · Studio-Editierbarkeit",
      "intro": "Zentrale Verwaltung aller automatischen Kunden-Nachrichten. Der Plattform-Admin legt Regeln an, bearbeitet und löscht sie und entscheidet pro Regel, ob das Studio sie ändern darf. Studios können Regeln mit „Studio darf ändern“ ein-/ausschalten und deren Tage-Wert anpassen — sie können keine Regeln anlegen oder löschen. Die tatsächliche Auslöse-/Versandlogik der Nachrichten bleibt unverändert.",
      "loadError": "Automatisierungen konnten nicht geladen werden",
      "saveError": "Speichern fehlgeschlagen",
      "saved": "Automatisierungen gespeichert",
      "activeCount": "aktiv",
      "studioMayChange": "Studio darf ändern",
      "centrallyManaged": "Zentral verwaltet",
      "days": "Tage",
      "on": "AN",
      "off": "AUS",
      "studioEditable": "Studio-editierbar",
      "studioEditableHint": "Darf das Studio diese Regel ändern?",
      "edit": "Bearbeiten",
      "delete": "Löschen",
      "cancel": "Abbrechen",
      "save": "Speichern",
      ...
      "addCategory": "+ Neue Kategorie",
      "deleteCategory": "Kategorie löschen",
      "emptyRules": "Noch keine Regeln in dieser Kategorie.",
      "editRule": "Regel bearbeiten",
      "addRuleTitle": "Neue Regel",
      ...
      "hasDaysField": "Tage-Feld?",
      "no": "Nein",
      "yes": "Ja",
      "yesDays": "Ja (Tage-Wert)",
      "noCentral": "Nein — zentral verwaltet",
      "defaultDays": "Tage-Wert (Standard)",
      "createRule": "Regel anlegen",
      "createCategory": "Kategorie anlegen",
      "labelsRequired": "Bezeichnung (DE und EN) darf nicht leer sein",
      "tageRange": "Tage-Wert muss zwischen {{min}} und {{max}} liegen",
      "tageRangeNew": "Tage-Wert muss zwischen 1 und 365 liegen",
      "katNotEmpty": "Bitte zuerst alle Regeln in dieser Kategorie löschen",
      "deleteRuleConfirm": "Regel „{{label}}“ wirklich löschen? Diese Aktion wird protokolliert.",
      "deleteCategoryConfirm": "Kategorie „{{label}}“ wirklich löschen?",
      "deleteCategoryBlocked": "Kategorie „{{label}}“ enthält noch Regeln. Bitte zuerst alle Regeln löschen.",
      "superAdminOnly": "Nur Super-Admin kann Automatisierungen bearbeiten."
    },
    "shop": {
