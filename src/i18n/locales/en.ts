...
const en = {
  ...
  "adminPages": {
    ...
    "finance": {
      ...
      "openStudioDetail": "Open sales for",
      "headers": {
        "studio": "Studio",
        "orders": "Orders",
        "revenue": "Revenue",
