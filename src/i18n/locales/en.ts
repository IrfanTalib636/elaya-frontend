...
const en = {
  ...
  "adminNav": {
    ...
    "comingSoonBody": "This section is part of the platform admin prototype. We will wire it to live data next — tell me which screen to implement first.",
    "searchPlaceholder": "Customer, Case, Studio…",
    "toolsHeading": "Platform tools",
    "versionLabel": "Elaya Admin v0.1",
    "lockHint": "Super admin access",
    "items": [
  ...
  "settingsPage": {
    ...
    "sessions": {
      ...
      "adminEditHint": "Changes apply platform-wide. Studios see updated rules live after save.",
      ...
      "toasts": {
        ...
        "saved": "Session prediction saved"
      }
    },
    "groupBooking": {
      "title": "Group booking",
    ...
    "elaycoinRules": {
      ...
      "intro": "Elaycoin rules are managed centrally by Elaya and apply to every studio. Changes are only possible in Elaya Admin.",
      "geldwert": "Value: {{coins}} Coins = CHF {{chf}}",
      "tageslimit": "Daily limit: {{n}} Coins",
      "grenze": "Per action: {{min}}–{{max}} Coins",
      "verfall": "Coins expire after {{months}} months of inactivity. Reset by: {{triggers}}.",
      "empty": "No action catalog loaded.",
      "active": "active",
      "malusHint": "Deduction (never below 0)",
      "once": "Once",
    ...
    "automations": {
      "title": "Automations",
      "intro": "Automations send automatic chat messages to customers. Rules are managed by Elaya. You can turn studio-editable rules on/off and adjust their days value — creating or deleting rules is reserved for platform admin.",
      "empty": "No automation rules yet.",
      "active": "active",
      "days": "Days",
      "locked": "Managed centrally by Elaya",
      "on": "ON",
      "off": "OFF"
    },
    "hours": {
  ...
  "studioPages": {
    ...
    "platformChat": {
      "title": "Support chat",
      "subtitle": "Direct messages with Elaya Support",
      "empty": "No messages yet — Elaya Support can reach you here.",
      "inputPlaceholder": "Write a message to Support…",
      "send": "Send",
      "youLabel": "You",
      "adminLabel": "Elaya Support",
      "typing": "Elaya Support is typing…",
      "live": "Live",
      "offline": "Offline",
      "openError": "Could not open Support chat",
      "sendError": "Could not send message",
      "newMessageTitle": "New message from Elaya Support"
    },
    "sessions": {
      "title": "Sessions",
    ...
    "shop": {
      "title": "ElayShop",
      "subtitle": "View catalog · your customers' orders · your commission",
      "readOnlyHint": "Products and commission rules are managed by Elaya. This screen is view-only — you can see the catalog, orders from your customers, and your commission.",
      ...
      "emptyDesc": "Orders appear here when your customers shop in ElayShop.",
      "emptyProductsTitle": "No products",
      "emptyProductsDesc": "The platform catalog is empty. Elaya will publish products here.",
      "tabOrders": "Orders",
      ...
      "footerHint": "View only. Product catalog and commission % are set by Elaya. Tap product names for order details."
    },
    "transfers": {
  ...
  "adminPages": {
    ...
    "overview": {
      ...
      "welcome": "Welcome, {{name}} — Elaya Platform Admin",
      "activeStudios": "Active Studios",
      "outstandingInvoices": "Outstanding invoices",
      "quickAccess": "Quick access",
      "recentActivity": "Recent activity",
      "activityEmpty": "No recent activity yet.",
      "activityStudioOpened": "Studio activity",
      "activityStudioListed": "Studio on platform",
      "quick": {
        "studios": {
          "title": "Manage studios",
          "desc": "Studio dashboard, locations & status"
        },
        "studioChat": {
          "title": "Studio Chat",
        ...
        "elaycoins": {
          "title": "Elaycoin rules",
          "desc": "Coin value, accounts & expiration"
        },
        "finance": {
          "title": "Finances",
          "desc": "Fees & Invoices"
    ...
    "studioChat": {
      "title": "Studio Chat",
      "subtitle": "Messages between Elaya Support and studios",
      "searchPlaceholder": "Search studio by name…",
      "emptyStudios": "No studios found.",
      "noMessagesYet": "No messages yet",
      "selectStudio": "Select a studio on the left to start chatting.",
      "threadEmpty": "No messages yet — say hello to this studio.",
      "inputPlaceholder": "Write a reply to the studio…",
      "send": "Send",
      "youLabel": "Elaya Support",
      "typing": "Studio is typing…",
      "live": "Live",
      "offline": "Offline",
      "inboxLoadError": "Could not load studios",
      "openError": "Could not open chat",
      "sendError": "Could not send message",
      "newMessageFrom": "New message from {name}",
      "newStudioMessage": "New studio message"
    },
    "customers": {
      "title": "Customers",
      "subtitle": "{{count}} customers across all studios",
      "loadError": "Could not load customers",
      "searchPlaceholder": "Search name, email, phone…",
      "emptyTitle": "No customers found",
      "emptySearch": "Try a different search term.",
      "emptyHint": "No customers are registered on the platform yet.",
      "noStudio": "No studio",
      "headers": {
        "name": "Name",
        "email": "Email",
    ...
    "crm": {
      "title": "CRM & Leads",
      "subtitle": "Pipeline, leads and platform CRM",
      "loadError": "Could not load CRM overview",
      "manageStudios": "Manage studios",
      "pipelineTitle": "Customer pipeline",
      "pipeline": {
        "app_downloaded": "Downloaded the app",
        "case_created": "Case created",
        "appointment_booked": "Appointment booked",
        "first_session": "First session",
        "active_treatment": "Active in treatment"
      },
      "registrationsTitle": "Studio registrations",
      "activeStudios": "Active Studios",
      "pendingApprovals": "Pending approvals",
      "closedStudios": "Closed studios",
      "onboardingTitle": "Studio onboarding (leads & contracts)",
      "onboardingDesc": "A studio goes through lead → contract sent → contract signed → onboarding → active. Only ACTIVE studios are bookable in the customer app. Website webhook / Stripe / e-signature can be wired later.",
      "captureLead": "Manually capture lead",
      "captureLeadHint": "Simulates a lead that later arrives automatically from the website or field sales.",
      "leadsEmpty": "No studio leads have been recorded yet.",
      "leadNoContact": "No contact details",
      "leadUntitled": "(no studio name)",
      "leadStatus": {
        "lead": "Lead",
      ...
      "akquise": {
        "website_demo": "Website — demo requested",
        "website_direkt": "Website — direct close",
        "aussendienst": "Field sales",
        "other": "Other"
      },
      "payment": {
        "STRIPE_KARTE": "Stripe (card)",
        "RECHNUNG": "Invoice"
      },
      "colFirma": "Studio",
      "colContact": "Contact",
      "colAkquise": "Acquisition",
      "colPaket": "Package",
      "colStatus": "Status",
      "colVisible": "Visible to customers",
      "colTrial": "Trial",
      "visibleYes": "Yes",
      "visibleNo": "No",
      "details": "Details",
      ...
      "trialEnded": "Ended",
      "trialExpiredNoPay": "Trial expired (no payment method)",
      "trialDaysLeft": "{{count}} days",
      "trialDaysUntil": "{{count}} days left (until {{date}})",
      "sectionContract": "Contract",
      "sectionAbo": "Subscription",
      "contractStatus": "Contract status",
      "contractSent": "Sent on",
      "contractSigned": "Signed on",
      "paymentMethod": "Payment method",
      "trialActive": "Free month active",
      "actionSendContract": "Mark contract as sent",
      "actionSignContract": "Mark contract as signed",
      "actionSetPayment": "Save payment method",
      "actionStartTrial": "Start free month (30 days)",
      "actionActivate": "Activate studio",
      "actionDeactivateTrial": "Trial expired — deactivate now",
      "activeHint": "Studio is active and bookable in the customer app.",
      "deactivatedHint": "This studio is deactivated and not bookable for customers.",
      "leadActionOk": "Status updated",
      "leadActionError": "Could not update status",
      "leadFirma": "Studio name",
      "leadContact": "Contact person",
      "leadEmail": "Email",
      "leadPhone": "Phone",
      "leadCity": "City",
      "leadAddress": "Address",
      "leadAkquise": "Acquisition channel",
      "leadPaket": "Desired package",
      "leadDemoBooked": "Demo appointment booked",
      "leadDemoDate": "Demo date",
      "leadNote": "Note",
      "leadFirmaRequired": "Studio name is required",
      "leadCreated": "Lead saved",
      "leadCreateError": "Could not save lead",
      "cancel": "Cancel",
      "saveLead": "Save lead",
      "attentionTitle": "Attention needed",
      "attentionOk": "Everything is fine — nothing currently requires attention.",
      "attentionPendingStudios": "{{count}} studio(s) awaiting approval",
      "attentionOpenLeads": "{{count}} open studio lead(s)",
      "activityTitle": "Recent activities (all studios)",
      "activityFilters": {
        "all": "All",
        "customers": "Customers",
        "studios": "Studios",
    ...
    "documentsPage": {
      "subtitle": "Central management for leaflets, anamnesis questions, consents and FAQs. Documents can be global or studio-specific and appear in the customer app or studio dashboard.",
      ...
      "titelRequired": "German title is required",
      "studioRequired": "Assign at least one studio for studio-specific documents",
      "fieldCategory": "Category",
      "fieldTitleDe": "Title (DE)",
      "fieldTitleEn": "Title (EN)",
      "fieldContentDe": "Content (DE)",
      "fieldContentEn": "Content (EN)",
      "fieldScope": "Scope",
      "fieldStudios": "Assigned studios",
      "fieldVisible": "Visible in",
      "fieldActive": "Active",
      "noStudios": "No studios available",
      "filterActive": "Filters active",
      "categories": {
        "merkblatt": "Leaflet",
        "anamnese_frage": "Anamnesis question",
      ...
      "scopes": {
        "global": "Global",
        "studio_spezifisch": "Studio-specific"
      },
      "visibility": {
    ...
    "adminChat": {
      ...
      "subtitle": "Platform assistant and internal admin messaging"
    },
    "aiTraining": {
      "title": "AI Training Center",
    ...
    "finance": {
      "title": "Finance",
      "subtitle": "Shop sales & studio commissions ({{pct}}% default). Stripe Connect payout: pending.",
      "subtitleAbo": "Pure subscription model: studio abo fee + Elaya shop share. No transaction fee. Amounts CHF excl. VAT.",
      "aboRecurring": "Recurring monthly revenue",
      "shopElayaMonth": "Shop revenue Elaya (month)",
      "totalElayaMonth": "Total revenue (month)",
      "openInvoices": "Open invoices",
      "aboModelTitle": "Pure subscription model",
      "aboModelRule1": "Revenue = subscription fee per studio + Elaya share of shop sales. NO transaction fee.",
      "aboModelRule2": "Acquisition source is for analysis only and does not affect fees.",
      "aboModelRule3": "All amounts in CHF, excl. VAT.",
      "totalSales": "Shop GMV",
      "studioCommission": "Studio commission",
      ...
      "detailError": "Could not load studio finance",
      "termsSaved": "Finance terms saved",
      "termsSaveError": "Could not save terms",
      "studiosTitle": "Sales by studio",
      "studiosTitleAbo": "Studios",
      "studiosHint": "Click a studio to see which products were sold.",
      "studiosHintAbo": "Click a studio for package terms, dual P&L and products.",
      "backToStudios": "Back to studios",
      "studioDetailTitle": "Studio finance",
      "studioDetailSubtitle": "{{code}} · Commission {{pct}}% on product sales",
      "studioDetailSubtitlePeriod": "Period {{period}} · Studio shop share {{pct}}%",
      "productsSoldTitle": "Products sold (current month)",
      "productsSoldHint": "Products sold through this studio, with commission per product.",
      "noProducts": "No products sold through this studio yet",
      "openStudioDetail": "Open finance for",
      "blockPackage": "A · Package & conditions",
      "blockPackageHint": "Effective abo fee and shop provision (override > package). Special terms require a reason (min. 10 characters).",
      "blockAkquise": "C · Customers (analysis)",
      "akquiseHint": "Acquisition source is analysis-only and does not affect fees.",
      "akquiseStudio": "Studio own",
      "akquisePlatform": "Platform referred",
      "akquiseTransfer": "Studio transfer",
      "plStudio": "D · Studio P&L (current month)",
      "plElaya": "D · Elaya P&L (current month)",
      "sessionRevenue": "Session revenue",
      "shopProvision": "Shop commission",
      "totalStudio": "Total Studio",
      "aboFee": "Subscription fee",
      "shopElayaShare": "Shop share (Elaya)",
      "totalElaya": "Total Elaya",
      "plNote": "Do not sum Studio total and Elaya total — they are separate views of the same period.",
      "packageLabel": "Package",
      "preisOverride": "Abo override (CHF)",
      "shopOverride": "Shop provision override %",
      "packageDefault": "Package default",
      "overrideReason": "Reason for special terms",
      "saveTerms": "Save terms",
      "clearOverrides": "Clear overrides",
      "shopProvisionPct": "Shop provision (studio)",
      "override": "Override",
      "statusActive": "Active",
    ...
    "features": {
      ...
      "subtitleAbo": "Subscription packages · AI weightings · studio feature flags. Pure abo model — no transaction fee.",
      "tabPackages": "Package management",
      "tabFlags": "Studio feature flags",
      ...
      "planDefaults": "Plan defaults — Starter: {{basic}} · Pro: {{pro}} · Network: {{ent}} features",
      "forceOn": "Force ON",
      "forceOff": "Force OFF",
      "planDefault": "Plan default",
      "kiWeightsTitle": "AI weightings",
      "kiWeightsHint": "How many units of the monthly AI quota a single use of this function consumes. Higher values for cost-intensive functions (e.g. image analysis).",
      "kiNachsorge": "Aftercare analysis (units/use)",
      "kiVerblassung": "Fading analysis (units/use)",
      "kiKundenchat": "Customer chat (units/use)",
      "kiStudioChat": "Studio AI chat (units/use)",
      "kiWeightsSave": "Save AI weightings",
      "kiWeightsSaved": "AI weightings saved",
      "kiWeightsError": "Could not save AI weightings",
      "kiWeightsInvalid": "Enter valid unit values (≥ 0) for all weightings",
      "packagesTitle": "Elaya packages",
      "newPackage": "+ New package",
      "editPackage": "Edit",
      "editPackageTitle": "Edit package",
      "newPackageTitle": "New package",
      "packageName": "Name",
      "aboPrice": "Subscription CHF / month",
      "description": "Description",
      "limitsTitle": "Limits",
      "limitsHint": "Empty field = unlimited.",
      "locationsIncl": "Locations included",
      "surchargeLocation": "Surcharge / location",
      "employees": "Employees",
      "shopProvision": "Shop provision studio",
      "shopProvisionHint": "Studio share of shop GMV. Per-studio exceptions only via Finance special terms (with reason).",
      "kiQuota": "AI quota",
      "kiQuotaHint": "Soft cap — never blocks AI. Overage can be billed separately. Empty = unlimited.",
      "dataRetention": "Data retention",
      "months": "months",
      "unlimited": "unlimited",
      "perMonth": "/mo",
      "featuresActive": "features active",
      "studiosWithPackage": "studio(s) on this package",
      "featuresTitle": "Features",
      "packageUpdated": "Package saved",
      "packageCreated": "Package created",
      "packageError": "Could not save package",
      "packageInvalid": "Enter name, valid price, and valid limits (shop provision ≥ 0)",
      "seatsTitle": "Employee login seats (per plan)",
      "seatsHint": "Synced from package employee limits when packages are saved. Empty = unlimited.",
      "allOn": "All ON",
      "allOff": "All OFF",
      "resetPackage": "Package default",
      "allOnSaved": "All features ON",
      "allOffSaved": "All features OFF",
    ...
    "elaycoins": {
      ...
      "subtitleRules": "Platform-wide Elaycoin rules · balances · admin corrections",
      "loadError": "Could not load Elaycoins",
      ...
      "tabRules": "Rules",
      "rulesLoadError": "Could not load Elaycoin rules",
      "rulesSaveError": "Could not save rules",
      "rulesSaved": "Elaycoin rules saved",
      "rulesIntro": "These rules apply platform-wide for all studios. Coins stay with the customer across studio switches, so values must be consistent. Only Super Admin can edit; studios view them read-only.",
      "globalTitle": "Global settings",
      "geldwert": "Coin monetary value",
      "coinsEquals": "Coins = CHF",
      "geldwertHint": "Redemption unit — identical for every studio on the platform.",
      "tageslimit": "Daily limit per customer",
      "coinsPerDay": "Coins / day",
      "grenzeAktion": "Limit per action",
      "min": "Min",
      "max": "Max",
      "coins": "Coins",
      ...
      "catalogTitle": "Categories & actions",
      "catalogHint": "Coin amounts granted or deducted per action. Add categories/actions, toggle active, save to apply platform-wide.",
      "catalogEmpty": "No actions in catalog.",
      "addCategory": "+ New category",
      "addAction": "+ Action",
      "deleteCategory": "Delete category",
      "deleteAction": "Delete action",
      "promptNewCategory": "New category name",
      "confirmDeleteCategory": "Delete category „{{kat}}“ and all actions?",
      "confirmDeleteAction": "Delete action „{{label}}“?",
      ...
      "repeatable": "Repeatable",
      "limitDays": "Days",
      "limitDaysHint": "Cooldown in days (limitTage)",
      "on": "ON",
      "off": "OFF",
      "active": "Active",
      "saveRules": "Save rules",
      "superAdminOnly": "Only Super Admin can edit rules."
    },
    "automations": {
      "title": "Automations",
      "subtitle": "Automatic customer messages · platform rules · studio-editable flags",
      "intro": "Central management of all automatic customer messages. The platform admin creates, edits and deletes rules and decides per rule whether the studio may change them. Studios can turn rules marked “Studio may change” on/off and adjust their days value — they cannot create or delete rules. Message send/trigger logic is unchanged.",
      "loadError": "Could not load automations",
      "saveError": "Could not save automations",
      "saved": "Automations saved",
      "activeCount": "active",
      "studioMayChange": "Studio may change",
      "centrallyManaged": "Centrally managed",
      "days": "Days",
      "on": "ON",
      "off": "OFF",
      "studioEditable": "Studio-editable",
      "studioEditableHint": "May the studio change this rule?",
      "edit": "Edit",
      "delete": "Delete",
      "cancel": "Cancel",
      "save": "Save",
      ...
      "addCategory": "+ New category",
      "deleteCategory": "Delete category",
      "emptyRules": "No rules in this category yet.",
      "editRule": "Edit rule",
      ...
      "hasDaysField": "Days field?",
      "no": "No",
      "yes": "Yes",
      "yesDays": "Yes (days value)",
      "noCentral": "No — centrally managed",
      "defaultDays": "Default days",
      "createRule": "Create rule",
      "createCategory": "Create category",
      "labelsRequired": "DE and EN labels are required",
      "tageRange": "Days must be between {{min}} and {{max}}",
      "tageRangeNew": "Days must be between 1 and 365",
      "katNotEmpty": "Delete all rules in this category first",
      "deleteRuleConfirm": "Really delete rule „{{label}}“? This is logged.",
      "deleteCategoryConfirm": "Really delete category „{{label}}“?",
      "deleteCategoryBlocked": "Category „{{label}}“ still has rules. Delete all rules first.",
      "superAdminOnly": "Only Super Admin can edit automations."
    },
    "shop": {
      "title": "Shop (platform)",
      "subtitle": "Products, orders and studio commissions",
      "superAdminOnlyHint": "Only super admin can add or edit products and mark commissions paid. This account is view-only.",
      "productsLoadError": "Could not load products",
    ...
    "transfers": {
      ...
      "info": "Change requests are generated when a customer requests a change in the app via \"My Studio → Change Studio\". They appear here for approval. After approval, the customer's studio updates in the app.",
      "loadError": "Could not load transfer requests.",
      "approved": "Studio change approved — customer moved to the new studio",
      ...
      "empty": "No requests",
      "emptyOpen": "No open transfer requests.",
      "emptyTitle": "No transfer requests",
      "emptyHint": "Pending requests from the customer app appear here for Elaya approval.",
      "customerFallback": "Customer",
      "approve": "Approve",
      "reject": "Reject",
      "rejectTitle": "Reject studio change",
