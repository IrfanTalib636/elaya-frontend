...
export default function StudioForgotPassword() {
  return (
    <div className="min-h-screen bg-studio-bg flex flex-col items-center justify-center font-sans px-4">
      <div className="w-full max-w-[380px] bg-studio-bg-3 border border-white/4 rounded-2xl p-8 flex flex-col gap-4 text-center">
        <img
          src={elayadLogo}
          alt="Elaya"
        ...
        <p className="text-studio-w3 text-[13px] m-0 leading-relaxed">
